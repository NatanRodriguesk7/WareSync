...
| Erro 401 "É necessário estar autenticado" em qualquer tela após o login | Cookie de sessão não está sendo enviado | Confirme que o backend está em `localhost:3000` e o frontend em `localhost:5500` (portas padrão do Live Server) — CORS já está configurado para essa combinação |
